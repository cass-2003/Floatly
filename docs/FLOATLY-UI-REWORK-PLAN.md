...
- 最新一轮已重新生成 `release/Floatly-Setup-2.0.22.exe` 和 `release/Floatly-2.0.22-win-x64.zip`，产物时间为 `2026-06-13 12:30` 左右；安装包和 zip 已包含设置页整条 Slider 轨道拖拽修复、收入助手输入框最小尺寸修复和番茄钟主按钮圆角修复。
