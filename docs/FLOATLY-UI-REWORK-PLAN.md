...
- 设置页主题选择卡已按 `design-3-dark.png` 的语义恢复为“主题预览卡”：深色卡保持深色预览、浅色卡保持浅色预览，当前选中态只用蓝色边框和勾选表达，避免在深色设置页中把浅色预览误染成暗色输入框。
...
- 深色设置页里的“浅色”主题卡必须作为浅色皮肤预览保留浅底深字，而不是跟随设置页当前深色主题变暗；后续主题卡验收以预览语义为准，选中态只检查边框和勾选。
