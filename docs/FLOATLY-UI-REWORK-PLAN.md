...
- 最新一轮已重新生成 `release/Floatly-Setup-2.0.22.exe` 和 `release/Floatly-2.0.22-win-x64.zip`，产物时间为 `2026-06-13 13:57` 左右；安装包和 zip 已包含主窗口默认尺寸 `608 x 1080`、设置页 Slider 轨道拖动命中层、背景遮罩 Slider 默认启用、收入助手输入框最小尺寸修复、番茄钟主按钮圆角修复和 v10 主面板玻璃可读性修复。
...
- 主面板对照 `resign-2-dark.png` 的默认尺寸截图已补齐 v16 release 证据；默认尺寸已从 `540 x 960` 调整为 `608 x 1080`，后续继续看深色背景穿透和小字号可读性。
